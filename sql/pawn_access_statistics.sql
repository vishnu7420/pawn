...
CREATE TABLE `access_statistics` (
  ...
  `logged_out` timestamp NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `shop_id` (`shop_id`),
  CONSTRAINT `access_statistics_ibfk_1` FOREIGN KEY (`shop_id`) REFERENCES `shop_details` (`shop_id`) ON DELETE CASCADE ON UPDATE RESTRICT
...
-- Dump completed on 2021-02-03 19:33:15
